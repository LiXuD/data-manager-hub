...
This project is indexed by GitNexus as **data-manager-hub** (10518 symbols, 24395 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
