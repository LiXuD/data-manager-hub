...
This project is indexed by GitNexus as **data-manager-hub** (13,685 nodes, 33,377 edges, 300 flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
