...
This project is indexed by GitNexus as **data-manager-hub** (10678 symbols, 24809 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
