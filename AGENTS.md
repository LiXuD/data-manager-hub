...
This project is indexed by GitNexus as **data-manager-hub** (8418 symbols, 19817 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
